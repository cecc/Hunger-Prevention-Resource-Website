...
$(document).ready(function(){
  ...
  <body>
  <div class="disclaimer" style="font-size:15px; font-family:Verdana; padding-top: 10px; width:100%; background-color:yellow; color:red; height: 50px; text-align:center;">This is a testing site ------ Site under construction. All information pending approval</div>
