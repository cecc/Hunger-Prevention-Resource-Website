...
<html lang="en"><head>
    ...
    <title>St. John's Soup Kitchen</title>
  ...
  <body style="font-family: "Open sans", Helvetica, Arial;">
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">St. John's Soup Kitchen</h1>
        <p class="lead blog-description">22 Mulberry St. • Newark, NJ 07102 •  973-623-0822</p>
      </div>
      ...
      <div class="carousel-inner">
        <div class="item">
          <img class="img-responsive center-block" src="../../images/St-Johns1.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item active">
          <img class="img-responsive center-block" src="../../images/St-Johns2.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="img-responsive center-block" src="../../images/St-Johns3.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <p>Our food pantry does not require a certain eligibility. Our services are open to singles with a photo ID, proof of income as well as their address. For families with children identification such as birth certificate is preferable for each individual child in the family. The parents of the families are only required to bring forth photo ID along with proof address.</p>
          </div><!-- /.blog-post -->
          <hr>
          <div class="blog-post">
            <h2 class="blog-post-title">Hours of Operation</h2>
            <br>
            <p>Tuesday through Saturday
              <br>Breakfast: 8:30 - 9 am
              <br>Lunch: 11:30 am - 12:30 pm</p>
          </div>
          <hr>
          <div class="blog-post">
            <h2 class="blog-post-title">St. John's Soup Kitchen</h2>
            <br>
...
<p>For more information on St. John's Soup Kitchen please click on <a href="http://www.njsoupkitchen.org/index.htm" target = "_blank">visit</a>.</p>
          </div>
          <div class="blog-post">
      ...
      <button type="button" class="btn btn-primary btn-lg">Send Message</button>           
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>About</h4>
            <p>Our overall mission is geared toward "supporting the family unit by changing the economic circumstances and improving the overall quality of life for children, the elderly, low-income families and the homeless". </p>
          </div>
