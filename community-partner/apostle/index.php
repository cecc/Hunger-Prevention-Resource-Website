...
<html lang="en"><head>
    ...
    <title>Apostle's House Food Pantry</title>
  ...
  <body style="font-family: "Open sans", Helvetica, Arial;">
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Apostle's House</h1>
        <p class="lead blog-description">24 Grant Street • Newark, NJ 07104 • (973) 482-0625</p>
      </div>
      ...
      <div class="carousel-inner">
        <div class="item">
          <img class="img-responsive center-block" src="apostle-house.jpg" alt="First slide">
<!--      <div class="container">
			<div class="carousel-caption">
              <h1>Apostle's House</h1>
            </div>
          </div> -->
        </div>
        <div class="item active">
          <img class="img-responsive center-block" src="apostle-house1.jpg" alt="Second slide">
<!--      <div class="container">
			<div class="carousel-caption">
      ...
      <button type="button" class="btn btn-primary btn-lg">Send Message</button>           
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>About</h4>
            <p>Apostles’ House Food Pantry is a major resource, which prevents or limits severe hunger in Newark. One of the largest food pantries in Essex County, we served over 8,500 people in 2007 and are one of only a handful open five days per week. The people we serve represent the many different faces of hunger from working families, to seniors raising grandchildren to single individuals many of whom are veterans.</p>
          </div>
