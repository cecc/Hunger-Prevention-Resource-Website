...
<html lang="en"><head>
    ...
    <title>St. Mary's/Pierre Tousssaint</title>
  ...
  <body style="font-family: "Open sans", Helvetica, Arial;">
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">St. Mary's/Pierre Toussaint</h1>
        <p class="lead blog-description">528 Dr. Martin Luther King Jr.Blvd • Newark, NJ 07102 • (201) 643-4800 Ext. 309</p>
      </div>
 ...
 <!--    <div class="item">
          <img class="img-responsive center-block" src="../../images/pierre-1.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item active">
          <img class="img-responsive center-block" src="../../images/pierre-1.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <br>
            <p>
            Pierre Toussaint Food Panty has been serving the needy of Newark for the past 30 years. As an emergency food assistance program we offer food assistance at the end of each month to registered clients and of course we respond to emergency situations whenever we are able.    
            </p>
            <p>
              As a member of the Catholic Charities MEND Food Network we endeavor to 
Meet Emergency Needs with Dignity. Each month we serve over 350 households - totaling over 800 men, women and children. We have seen an increase of those looking for assistance including the working poor, senior citizens and newly unemployed. 

            <p>
              In 2010 we served over 7,433 men, women, and children.
              In 2008 we touched over 6,000 men, women and children.
          ...
          <div class="blog-post">
            ...
            <p>
             Registration:<br>
            1st and 2nd Saturdays 11:30AM - 12:30 PM
          </p>
            ...
            <p>
                ...
                <ul>
                        ...
                        <li>Current ID</li>
                        <li>Proof of Income or Assistance</li>
                        <li>Verification of Children/dependents</li>
                </ul
            </p>
          </div><!-- /.blog-post -->
          <hr>
          <div class="blog-post">
            ...
            <br>
            <p>
               3rd and 4th Fridays for Singles 10:00AM - Noon<br>
               3rd and 4th Fridays for Families 10:00AM - Noon
            </p>
          </div>
          <hr>
          <!--<div class="blog-post">
      ...
      <button type="button" class="btn btn-primary btn-lg">Send Message</button>           
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>About</h4>
            <p>Pierre Toussaint Food Panty has been serving the needy of Newark for the past 23 years. As an emergency food assistance program we offer food assistance at the end of each month to registered clients and of course we respond to emergency situations whenever we are able. 

As a member of the Catholic Charities MEND Food Network we endeavor to Meet Emergency Needs with Dignity. </p>
          </div>
