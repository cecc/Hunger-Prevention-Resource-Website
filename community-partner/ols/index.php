  ...
  <body style="font-family: "Open sans", Helvetica, Arial;">
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Our Lady of Sorrows</h1>
        <p class="lead blog-description">217 Prospect Street • South Orange, NJ 07079 • (973) 763-5454</p>
      </div>
      ...
      <div class="carousel-inner">
        <div class="item">
          <img class="img-responsive center-block" src="logo.jpg" alt="First slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Our Lady of Sorrows</h1>
            </div>
          </div>
        </div>
        <div class="item active">
          <img class="img-responsive center-block" src="ourMisson.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <p>For food services that we provide you must be eligible with the requirements below. All individuals must have a photo id and birth certificate for the children under 18 years old.</p>

                <ul>
                    <li>Families with Children under 18</li>
                    <li>Senior Citizens</li>
                </ul>
            <p>In order for you to be able to receive food you must have a referral from an agency below.</p>
          </div><!-- /.blog-post -->
          <hr>
          <div class="blog-post">
      ...
      <button type="button" class="btn btn-primary btn-lg">Send Message</button>           
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>About</h4>
            <p>The present church of Our Lady of Sorrows, begun in April of 1929, was dedicated by Bishop Thomas J. Walsh in June of 1931.  In 1984, Archbishop Peter L. Gerety authorized the renovation of the church which was rededicated by Archbishop Theodore McCarrick in December 21st, 1986.</p>
          </div>
