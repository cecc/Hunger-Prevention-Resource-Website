...
<html lang="en"><head>
    ...
    <title>St. James Social Service Corporation</title>
  ...
  <body style="font-family: "Open sans", Helvetica, Arial;">
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">St. James Social Service Corporation</h1>
        <p class="lead blog-description">604 Dr Martin Luther King Jr. BLVD • Newark, NJ 07102 •  973-624-4007</p>
      </div>
      ...
      <div class="carousel-inner">
		<div class="item">
          <img class="img-responsive center-block" src="St_James_Social1.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item active">
          <img class="img-responsive center-block" src="St_James_Social.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
...
<!--    <div class="item">
          <img class="img-responsive center-block" src="gallery-23.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
      ...
      <div class="row">
        ...
        <div class="blog-post">
          ...
          <div class="blog-post">
            ...
            <br>
            <p>The food pantry hours of operation are Monday through Friday from 9 a.m. to 5 in the evening. On the weekends it runs from 9 in the morning to 1 in the afternoon.</p>
          </div>
          <hr>
          <!--<div class="blog-post">
