...
<body>
    ...
    <div class="blog-header">
          <h1 class="blog-title">Getting Involved</h1>
     </div>
...
<p>Spread the word of this end hunger project to your local officials, next door neighbors, and even your nearest community center. Through advocating we hope to gain new community partners who are determined to join our cause. </p>
